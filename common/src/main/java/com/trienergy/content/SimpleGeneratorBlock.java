...
public class SimpleGeneratorBlock extends Block implements EntityBlock {
    ...
    public SimpleGeneratorBlock(BlockBehaviour.Properties properties) {
        super(properties);
    }
    ...
    public BlockEntity newBlockEntity(BlockPos pos, BlockState state) {
        return new SimpleGeneratorBlockEntity(pos, state);
    }
    ...
    public void onPlace(BlockState state, Level level, BlockPos pos, BlockState oldState, boolean movedByPiston) {
        ...
        if (!level.isClientSide && level instanceof net.minecraft.server.level.ServerLevel serverLevel) {
            ...
            if (be instanceof SimpleGeneratorBlockEntity gen) {
